...
public interface EventsRepository extends JpaRepository<Events, Integer> {
    ...
    @Query(value = "SELECT ID_NOTIFICATION, ID_VACA, NOMBRE_EVENTO, FECHA_EVENTO, ESTADO FROM EVENTS WHERE ID_VACA = :idVaca", nativeQuery = true)
    List<Events> getByIdVaca(Integer idVaca);
}
